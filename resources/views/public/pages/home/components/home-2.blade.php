        ...
        <div class="row demo-block">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 wow pulse">
                <div class="demo-box text-center">
                    ...
                    <div class="demo-title"><a class="btn" href="https://www.acm.org/" target="_blank"><i class="fa fa-paper-plane"></i></a></div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-6 wow pulse">
                <div class="demo-box text-center">
                    ...
                    <div class="demo-title"><a class="btn" href="https://link.springer.com/" target="_blank"><i class="fa fa-paper-plane"></i></a>
                    </div>
                </div>
            </div>
        </div>
