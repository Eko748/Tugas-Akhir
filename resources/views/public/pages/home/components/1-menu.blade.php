                    ...
                    <div class="form-group col-md-12 text-center">
                        <div class="input-group col-md-4 input-group-lg mb-3">
                            ...
                            <input id="search" type="text" class="form-control"
                                value="https://link.springer.com/chapter/10.1007/11774129_8" aria-label="Example text with button addon"
                            ...
                            <button class="btn btn-outline-primary" data-bs-trigger="hover" data-container="body"
                                ...
                                data-bs-content="Terapkan format URL pada kolom pencarian seperti: (https://link.springer.com/chapter/10.1007/11774129_8)">
