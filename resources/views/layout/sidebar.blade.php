    ...
    <div class="logo-wrapper">
      <a href="/"
        ><img
          ...
          src="{{ asset('assets/images/logo/small-white-logo.png') }}"
          alt=""
      /></a>
      ...
      <div id="sidebar-menu">
          ...
          <li class="sidebar-list">
            ...
            <a class="sidebar-link" href="{{ route('dashboard.admin.index') }}">
              <svg
                ...
                </g></svg><span class="dashboard">Dashboard </span></a>
          ...
          <li class="sidebar-list">
            <a class="sidebar-link sidebar-title" href="#">
              ...
              >
                ...
                </g></svg><span class="management">Management</span></a>
            <ul class="sidebar-submenu">
              <li><a href="{{ route('management.employee.index') }}">Karyawan</a></li>
              <li><a href="{{ route('management.product.index') }}">Product</a></li>
              <li>
                <a class="submenu-title" href="#"
                  >Journal Detail<span class="sub-arrow"
                    ><i class="fa fa-angle-right"></i></span
                ></a>
                <ul class="nav-sub-childmenu submenu-content">
                  <li><a href="{% url 'finance:show_jurnal_pendapatan' %}">Jurnal Pendapatan</a></li>
                  <li><a href="{% url 'finance:show_jurnal_pengeluaran' %}">Jurnal Pengeluaran</a></li>
          ...
          <li class="sidebar-list">
            ...
            ><a class="sidebar-link sidebar-title" href="#">
              ...
              >
                ...
                </g></svg><span class="settings">Settings </span></a>
            <ul class="sidebar-submenu">
        ...
        <div class="sidebar-img-section">
          <div class="sidebar-img-content">
            <img
              class="img-fluid"
              src="{{ asset('assets/images/side-bar.png') }}"
              alt=""
            />
            <h4>Need Help ?</h4>
            <a class="txt" href="https://pixelstrap.freshdesk.com/support/home"
              >Raise ticket at "support@pixelstrap.com"</a
            ><a
