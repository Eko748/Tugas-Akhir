...
<li class="sidebar-list">
    ...
    <ul class="sidebar-submenu">
        ...
        @php
            $projects = App\Models\Project::with('getLeader')
            ...
            @if ($current_time <= $end_date)
                <li>
                    <a href="{{ route('management.project.detail', ['uuid_project' => $project->uuid_project]) }}"
                        data-bs-trigger="hover" data-container="body" data-bs-toggle="popover" data-bs-placement="right"
                        data-offset="-5px -5px" data-bs-content="{{ $project->description }}"
                        title="{{ $project->title }}">
...
<li class="sidebar-list">
    ...
    <ul class="sidebar-submenu">
        <li><a href="{{ route('review.index') }}">Review Master</a></li>
        <li><a href="{{ route('review.index') }}">IEEE</a></li>
        <li><a href="{{ route('review.index') }}">Science Direct</a></li>
        <li><a href="{{ route('review.index') }}">Springer</a></li>
        <li><a href="{{ route('review.index') }}">CiterX</a></li>
        <li><a href="{{ route('review.index') }}">UCM</a></li>
    </ul>
</li>
