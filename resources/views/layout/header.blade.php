      ...
      <ul class="nav-menus">
        ...
        <li class="cart-nav onhover-dropdown">
              ...
              <g>
                <g>
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    fill="#130F26" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                  </path>
                  <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <div class="cart-dropdown onhover-show-div">
            <div class="dropdown-title">
              <h3>Cart </h3><a class="f-right" href="/ecommerce_cart"> <i data-feather="shopping-bag">
                </i></a>
            </div>
            <ul class="custom-scrollbar">
              <li>
                <div class="media"><img class="img-fluid b-r-5 me-3 img-50"
                  ...
                  <div class="media-body">
                    <h5> <a href="/ecommerce_product_view">Black shirt with jecket</a></h5>
                    <p class="f-w-700">$500</p>
                    <div class="cart-quantity"><span class="plus"><i class="fa fa-plus"></i></span>
                      <input class="count" type="text" name="qty" value="2"><span class="minus"><i
              ...
              <li>
                <div class="media"><img class="img-fluid b-r-5 me-3 img-50"
                  ...
                  <div class="media-body">
                    <h5> <a href="/ecommerce_product_view">Yellow white shirt.</a></h5>
                    <p class="f-w-700">$500</p>
                    <div class="cart-quantity"> <span class="plus"><i class="fa fa-plus"></i></span>
                      <input class="count" type="text" name="qty" value="2"><span class="minus"><i
                          class="fa fa-minus"></i></span>
              ...
              <li>
                <div class="media"><img class="img-fluid b-r-5 me-3 img-50"
                  ...
                  <div class="media-body">
                    <h5> <a href="/ecommerce_product_view">Nike Black shoes !</a></h5>
                    <p class="f-w-700">$500</p>
                    <div class="cart-quantity"> <span class="plus"><i class="fa fa-plus"></i></span>
                      <input class="count" type="text" name="qty" value="2"><span class="minus"><i
                          class="fa fa-minus"></i></span>
              ...
              <li class="order-total">
                <h4 class="mb-0 f-w-700">Total : <span>$100.00</span></h4><a class="btn btn-primary view-checkout"
                  href="/ecommerce_checkout">Checkout</a>
              </li>
            </ul>
          </div>
        </li>
                      ...
                      <div class="row">
                        <div class="col-4 text-center">
                          <div class="bookmark-content">
                            ...
                            <h5 class="mt-2"> <a href="/form_form_validation">Forms</a></h5>
                          </div>
                        </div>
                        <div class="col-4 text-center">
                          <div class="bookmark-content">
                            <div class="bookmark-icon"><i data-feather="user"></i></div>
                            <h5 class="mt-2"> <a href="/users_users_profile">Profile</a></h5>
                          </div>
                        </div>
                        <div class="col-4 text-center">
                          <div class="bookmark-content">
                            <div class="bookmark-icon"><i data-feather="server"></i></div>
                            <h5 class="mt-2"> <a href="/data_tables_basic_init">Tables</a></h5>
                          </div>
                        </div>
                      </div>
                    </li>
        ...
        <li class="onhover-dropdown">
          ...
          <div class="onhover-show-div notification-dropdown">
            <div class="dropdown-title">
              <h3>Notification</h3><a class="f-right" href="/ecommerce_cart"> <i data-feather="bell">
                </i></a>
            </div>
            <ul class="custom-scrollbar">
              <li>
                <div class="media">
                  <div class="notification-img bg-light-primary"><img src="{{ asset('assets/images/avtar/man.png') }}"
                      alt=""></div>
                  <div class="media-body">
                    <h5> <a class="f-14 m-0" href="/users_users_profile">Allie Grater</a></h5>
              ...
              <li>
                <div class="media">
                  ...
                  <div class="media-body">
                    <h5> <a class="f-14 m-0" href="/users_users_profile">Olive Yew</a></h5>
              ...
              <li>
                <div class="media">
                  <div class="notification-img bg-light-info"><img src="{{ asset('assets/images/avtar/teenager.png') }}"
                      alt=""></div>
                  <div class="media-body">
                    <h5> <a class="f-14 m-0" href="/users_users_profile">Peg Legge</a></h5>
              ...
              <li>
                <div class="media">
                  ...
                  <div class="media-body">
                    <h5> <a class="f-14 m-0" href="/users_users_profile">Teri Dactyl</a></h5>
            ...
            <li>
              <form method="POST" action="{{ route('logout') }}">
                ...
                <a href="{{ route('logout') }}" onclick="event.preventDefault();
                    this.closest('form').submit();"><i data-feather="file-text">
                      </i><span>Log out</span>
                </a>
              </form>
            </li>
