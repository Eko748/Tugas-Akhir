<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="left-side-header col ps-0 d-none d-md-block">
            <form id="route-search-form" style="background: transparent;">
                <div class="input-group">
                    <span class="input-group-text" id="basic-addon1">
                        <button class="mt-2" style="background: transparent; border:transparent;" type="submit">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <g>
                    ...
                    <input id="hehe" list="route" class="form-control" name="route" type="text"
                        ...
                        <ul class="custom-scrollbar">
                                ...
                                <div class="media"><img class="img-fluid b-r-5 me-3 img-50"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="cart-quantity"><span class="plus"><i
                                            ...
                                            <input class="count" type="text" name="qty" value="2"><span
                            ...
                            <li class="order-total">
                                <h4 class="mb-0 f-w-700">Total : <span>$100.00</span></h4><a
                                    class="btn btn-primary view-checkout" href="/ecommerce_checkout">Checkout</a>
                            </li>
                        </ul>
                    </div>
                </li> --}}
                                            ...
                                            <div class="row">
                                                <div class="col-4 text-center">
                                                    <div class="bookmark-content">
                                                        ...
                                                        <h5 class="mt-2"> <a href="/form_form_validation">Forms</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                                <div class="col-4 text-center">
                                                    <div class="bookmark-content">
                                                        ...
                                                        <h5 class="mt-2"> <a href="/users_users_profile">Profile</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                                <div class="col-4 text-center">
                                                    <div class="bookmark-content">
                                                        ...
                                                        <h5 class="mt-2"> <a
                                                                href="/data_tables_basic_init">Tables</a></h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
