<div class="modal fade" id="employee" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="formCreateEmployee" class="theme-form needs-validation" method="POST" action=""
                novalidate="">
                @csrf
                ...
                <div class="modal-footer">
                    ...
                    {{-- @include('admin.pages.management.employee.components.button') --}}
