...
@include('admin.pages.management.employee.content.employee')
...
@include('admin.pages.management.employee.js.table-js')
{{-- @include('admin.pages.management.employee.js.searchTable-js') --}}
@include('admin.pages.management.employee.js.crud-js')
@include('admin.pages.management.employee.js.validate-js')
@include('admin.pages.management.employee.js.getUser-js')
