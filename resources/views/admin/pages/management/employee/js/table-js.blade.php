...
$('#table-employee thead tr')
  ...
  .appendTo('#table-employee thead');
        $('#table-employee').DataTable({
                ...
                api
                    ...
                    .each(function(colIdx) {
                        if (colIdx == 5) {
                            ...
                            let title = $(cell).text();
                            $(cell).html('<input id="" type="search" class="user form-control form-control-sm" placeholder="' + title + '">');
                            ...
                            let title = $(cell).text();
                            $(cell).html(
                                '<small><input id="" class="user form-control" placeholder="' + title + '"></small>'
            ...
            ajax: "{{ route('management.employee.table') }}",
            columns: [
                {
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
