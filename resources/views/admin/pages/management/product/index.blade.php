...
@include('admin.pages.management.product.content.product')
...
<!-- Plugins JS start-->
@include('admin.pages.management.product.js.product-js')
@include('admin.pages.management.product.js.getUser-js')
<!-- Plugins JS Ends-->
@endpush
@endsection
