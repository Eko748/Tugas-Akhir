                ...
                <div class="product-search">
                    <div class="form-group col-md-8">
                        <div class="input-group col-md-4 input-group-lg mb-3">
                            ...
                            <input id="search" type="text" class="form-control" placeholder="Ex: 10.1007/s10118-023-2956-9"
                            ...
                            <button class="btn btn-outline-primary" data-bs-trigger="hover" data-container="body"
                                ...
                                data-bs-content="Terapkan 2 suffix terakhir seperti pada tautan (https://link.springer.com/article/10.1007/s10118-023-2956-9) yaitu (10.1007/s10118-023-2956-9) kedalam kolom pencarian">
