    ...
    <div class="row m-b-10">
        <div class="col-md-3 col-sm-2 products-total">
            <div class="square-product-setting d-inline-block">
                <a class="icon-grid grid-layout-view" href="#card">
                    <i data-feather="grid"></i>
                </a>
            </div>
            <div class="square-product-setting d-inline-block">
                <a class="icon-grid m-0 list-layout-view" href="#list">
            ...
            <div class="pro-filter-sec">
                <div class="product-search">
                    <div class="form-group col-md-8">
                        <span id="empty-search-message" style="display: none; color: red;">
                            Mohon isi kolom pencarian
                        </span>
                        <div class="input-group col-md-4 input-group-lg mb-3">
                            <button class="btn btn-outline-primary" type="button" id="submit-review">
                                <i class="fa fa-search"></i>
                            </button>
                            <input id="search" type="text" class="form-control"
                                placeholder="Search : https://ieeexplore.ieee.org/document/6606614"
