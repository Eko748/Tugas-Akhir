<div class="col-xl-4 col-md-6 dash-31 dash-xl-50 box-col-6">
        ...
        <table class="table table-bordernone">
          <tbody>
            <tr>
              <td>
                <div class="media"><img class="img-fluid me-3 b-r-5"
                    src="{{ asset('assets/images/dashboard/rectangle-26.jpg') }}" alt="">
                  <div class="media-body"><a href="/blog_single">
            ...
            <tr>
              <td>
                <div class="media"> <img class="img-fluid me-3 b-r-5"
                    src="{{ asset('assets/images/dashboard/rectangle-27.jpg') }}" alt="">
                  <div class="media-body"><a href="/blog_single">
            ...
            <tr>
              <td>
                <div class="media"><img class="img-fluid me-3 b-r-5"
                    src="{{ asset('assets/images/dashboard/rectangle-28.jpg') }}" alt="">
                  <div class="media-body"><a href="/blog_single">
            ...
            <tr>
              <td>
                <div class="media"><img class="img-fluid me-3 b-r-5"
                    src="{{ asset('assets/images/dashboard/rectangle-29.jpg') }}" alt="">
                  <div class="media-body"><a href="/blog_single">
...
<div class="col-xl-4 col-md-6 dash-35 dash-xl-50 box-col-6">
          ...
          <tbody>
              ...
              <td>
                <div class="media">
                  <div class="square-box me-2"><img class="img-fluid b-r-5"
                      src="{{ asset('assets/images/avtar/boy.png') }}" alt=""></div>
            ...
            <tr>
              <td>
                <div class="media">
                  <div class="square-box me-2"><img class="img-fluid b-r-5"
                      src="{{ asset('assets/images/avtar/girl.png') }}" alt=""></div>
                  <div class="media-body ps-2">
                    <div class="avatar-details"><a href="/ecommerce_product_page">
                        <h6>Ralph Waters</h6>
            ...
            <tr>
              <td>
                <div class="media">
                  <div class="square-box me-2"><img class="img-fluid b-r-5"
                      src="{{ asset('assets/images/avtar/woman.png') }}" alt=""></div>
                  <div class="media-body ps-2">
                    <div class="avatar-details"><a href="/ecommerce_product_page">
                        <h6>Gary</h6>
                      </a><span> UK Desig Team</span></div>
            ...
            <tr>
              <td>
                <div class="media">
                  ...
                  <div class="media-body"><a href="/users_users_profile">
                ...
                <div class="media">
                  ...
                  <div class="media-body"><a href="/users_users_profile">
                    ...
                    <div class="activity-msg"> <span class="activity-msg-box">
                        Again this was our mistake, we are truly sorry for not adhering to a strictly non animal product
                        event.</span></div>
                  </div>
                </div>
              </td>
            ...
            <tr>
              <td>
                <div class="media">
                  ...
                  <div class="media-body image-swipe"><a href="/users_users_profile">
                    ...
                    <div class="my-gallery" itemscope="">
                      <div class="row gallery">
                        <figure class="inner-img ms-3" itemprop="associatedMedia" itemscope=""><a
                            href="{{ asset('assets/images/dashboard/img-26.jpg') }}" itemprop="contentUrl"
                            data-size="600x600"><img class="img-fluid img-40"
                              src="{{ asset('assets/images/dashboard/img-26.jpg') }}" itemprop="thumbnail"
                              alt="Image description"></a>
                          <figcaption itemprop="caption description">Photos 1</figcaption>
                        </figure>
                        <figure class="inner-img ms-3" itemprop="associatedMedia" itemscope=""><a
                            href="{{ asset('assets/images/dashboard/image-20.jpg') }}" itemprop="contentUrl"
                            data-size="600x600"><img class="img-fluid img-40"
                              src="{{ asset('assets/images/dashboard/image-20.jpg') }}" itemprop="thumbnail"
                              alt="Image description"></a>
