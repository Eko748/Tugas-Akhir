...
@include('pages.scraping.review.content.js.get-project-js')
@include('pages.scraping.review.content.js.get-category-js')
@include('pages.scraping.review.content.js.create-data-js')
