...
class Job extends BasicSpider
{
    public array $startUrls = [
        'https://ieeexplore.ieee.org/document/9636915'
    ];
    ...
    public function parse(Response $response): \Generator
    {
        ...
        // $jobType =  $response->filter('.breadcrumbs.col.text-sm-md-lh span:nth-of-type(1) a')->text();
